...
ws.on('caption', (data) => {
  ...
  },
  {
    ...
    responsePayload: {
      ...
      timestamp: "2026-09-09T01:08:00Z",
      metrics: { score: 88, totalIssues: 4, critical: 1, high: 1 }
    },
  ...
  -d '{"url":"https://example.com/checkout"}'`,
    nodeSnippet: `import { AccessAI } from '@accessai/sdk';
const client = new AccessAI({ apiKey: process.env.ACCESSAI_KEY });
const result = await client.scanner.analyzeUrl('https://example.com');`
  }
];
