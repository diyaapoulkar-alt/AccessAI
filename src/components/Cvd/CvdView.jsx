...
import { Eye, Layers, TrendingUp, AlertTriangle, SlidersHorizontal, Activity, FileCheck, CheckCircle2, XCircle } from 'lucide-react';
  ...
  return (
    <div className="max-w-7xl mx-auto space-y-6 px-4 sm:px-6 py-4">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div className="space-y-1.5">
            ...
            <p className="text-stone-600 text-xs sm:text-sm max-w-2xl font-normal">
              Simulate Deuteranopia, Protanopia, Tritanopia, and Achromatopsia using exact Brettel and Machado transform matrices.
            </p>
          </div>

          {isSimulating && (
            <span className="text-xs font-bold px-3.5 py-1.5 rounded-full bg-stone-900 text-white shadow-xs shrink-0">
      ...
      <div className="bg-white border border-stone-200/90 rounded-3xl p-6 shadow-sm">
        ...
        >
          <div className="bg-stone-950 border border-stone-800 rounded-2xl p-6 space-y-6 text-white">
